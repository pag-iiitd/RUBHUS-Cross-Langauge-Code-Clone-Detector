...
def get_positive_expectation(p_samples, measure, average=True):
    ...
    if average:
        # print("get_positive_expectation"+str(Ep.mean()))
        return Ep.mean()
    else:
        # print("get_positive_expectation"+str(Ep))
        return Ep
...
def get_negative_expectation(q_samples, measure, average=True):
    ...
    if average:
        # print("get_negative_expectation"+str(Eq.mean()))
        return Eq.mean()
    else:
        # print("get_negative_expectation"+str(Eq))
        return Eq
...
def local_global_loss_(l_enc, g_enc, edge_index, batch, measure):
    ...
    # print("Infomax local_global_loss_ E_neg-> " + str(E_neg))
    # print("Infomax local_global_loss_ E_pos-> " + str(E_pos))
    # print("Infomax local_global_loss_ subs " + str(E_neg - E_pos))
    return E_neg - E_pos
